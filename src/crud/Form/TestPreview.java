...
//    }
    ...
    private JPanel createTextPane() {
        ...
        try {
            tp.setPage(new java.io.File("C:\\Users\\priad\\Downloads\\Cetak.html").toURI().toURL());
        } catch (Exception ex) {
        }
    ...
    private JPanel createTable() {
        String val[][] = {{"Indonesia", "Jakarta"}, {"Nepal", "Katmandu"}, {"Afghanistan", "Kabul"},
        {"Burma", "Myanmar"}, {"China", "Beijing"}, {"Thailand", "Bankok"}
        };
        String title[] = {"Negara", "Ibukota"};
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (com.equals("Page Setup")) {
            ...
            new PrintPreview(tp.getPrintable(new MessageFormat("Judul Surat"),
            ...
            new PrintPreview(tab.getPrintable(javax.swing.JTable.PrintMode.FIT_WIDTH,
                    new MessageFormat("Negara"), new MessageFormat("{0}")), pj.getPageFormat(att));
